...
<title>403 &middot; <?= e($brand) ?></title><link rel="stylesheet" href="<?= asset('css/app.css') ?>"></head>
<body class="min-h-screen bg-slate-50 flex items-center justify-center p-6">
<div class="text-center">
    <div class="text-7xl font-extrabold text-rose-600">403</div>
    <h1 class="mt-4 text-xl font-bold text-slate-800">Akses ditolak</h1>
    <p class="text-slate-500 mt-1">Anda tidak memiliki izin untuk membuka halaman ini.</p>
